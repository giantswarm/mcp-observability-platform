...
- Faster multi-arch build by reusing architect-built binaries

## [0.2.1] - 2026-06-26

### Fixed

- Fix docker multi-arch images with proper architectures
...
- `golang.org/x/net` bumped to v0.55.0 (GO-2026-5026: incorrect IDNA label validation in `golang.org/x/net/idna`).
...
[Unreleased]: https://github.com/giantswarm/mcp-observability-platform/compare/v0.2.1...HEAD
