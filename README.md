...
# mcp-observability-platform chart

Giant Swarm offers a mcp-observability-platform App which can be installed in workload clusters.
Here, we define the mcp-observability-platform chart with its templates and default configuration.
